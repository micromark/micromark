...
test('html', function (t: any) {
  t.test('1 (raw)', function (t: any) {
    t.equal(
      m(
        [
  ...
  t.test('2 (comment)', function (t: any) {
    t.equal(
      m('<!-- Foo\n\nbar\n   baz -->\nokay', unsafe),
      '<!-- Foo\n\nbar\n   baz -->\n<p>okay</p>',
  ...
  t.test('3 (instruction)', function (t: any) {
    t.equal(
      m("<?php\n\n  echo '>';\n\n?>\nokay", unsafe),
      "<?php\n\n  echo '>';\n\n?>\n<p>okay</p>",
  ...
  t.test('4 (declaration)', function (t: any) {
    t.equal(
  ...
  t.test('7 (complete)', function (t: any) {
    t.equal(
      m('<a href="foo">\n*bar*\n</a>', unsafe),
      '<a href="foo">\n*bar*\n</a>',
