...
function tokenizeCharacterReference(effects, ok, nok) {
  ...
  function start(code) {
    ...
    if (code !== characters.ampersand) return nok(code)
  ...
  function numericStart(code) {
    if (code === characters.uppercaseX || code === characters.lowercaseX) {
...
function parseNumber(value, base) {
  return fromCharCode(parseInt(value, base) || characters.replacementCharacter)
}
