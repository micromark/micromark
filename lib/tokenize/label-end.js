...
// Perf to do: this might have to be put in `resolveAll`.
...
function tokenizeResource(effects, ok, nok) {
  ...
  function open(code) {
    ...
    effects.enter(types.resourceDestinationString).contentType =
  ...
  function titleStart(code) {
    ...
    effects.enter(types.resourceTitleString).contentType =
      constants.contentTypeString
    return title(code)
  }
...
function tokenizeFullReference(effects, ok, nok) {
  ...
  function start(code) {
    ...
    effects.enter(types.referenceString).contentType =
      constants.contentTypeString
