var tokenize = tokenizeListStart
var continuation = {tokenize: tokenizeListContinuation}
var exit = tokenizeListEnd
...
function tokenizeListContinuation(effects, ok, nok) {
  ...
  function notInCurrentItem(code) {
    ...
    return spaceFactory(
      effects,
      effects.attempt(
        {tokenize: tokenize, continuation: continuation, exit: exit},
        ok,
        nok
      ),
      types.linePrefix,
