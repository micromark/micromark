...
function tokenizeDefinition(effects, ok, nok) {
  ...
  function start(code) {
    ...
    effects.enter(types.definitionLabelString).contentType = 'string'
    return label
  }
  ...
  function between(code) {
    ...
    effects.enter(types.definitionDestinationString).contentType = 'string'
    effects.consume(code)
  ...
  function destinationAfter(code) {
    return effects.createConstructAttempt(title, after, after)(code)
  }
...
function tokenizeTitle(effects, ok, nok) {
  ...
  function dataStart(code) {
    ...
    effects.enter(types.definitionTitleString).contentType = 'string'
    effects.consume(code)
