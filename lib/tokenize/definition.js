...
function tokenizeDefinition(effects, ok, nok) {
  ...
  function start(code) {
    ...
    effects.enter(types.definitionLabelString).contentType =
  ...
  function between(code) {
    ...
    effects.enter(types.definitionDestinationString).contentType =
      constants.contentTypeString
    effects.consume(code)
...
function tokenizeTitle(effects, ok, nok) {
  ...
  function dataStart(code) {
    ...
    effects.enter(types.definitionTitleString).contentType =
      constants.contentTypeString
    effects.consume(code)
