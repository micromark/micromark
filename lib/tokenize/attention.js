...
import {classifyCharacter} from '../util/classify-character.js'
import {movePoint} from '../util/move-point.js'
    ...
    if (
      ...
      while (open--) {
        ...
        if (
          ...
          const start = shallow(events[open][1].end)
          const end = shallow(events[index][1].start)
          movePoint(start, -use)
          movePoint(end, use)
