...
function text(effects) {
  ...
  hooks[characters.cr] = whitespace
  hooks[characters.lf] = whitespace
  hooks[characters.crlf] = whitespace
  hooks[characters.ht] = whitespace
  hooks[characters.space] = whitespace
