...
import decodeEntity from 'parse-entities/decode-entity'
import * as codes from '../character/codes'
import assign from '../constant/assign'
import * as constants from '../constant/constants'
import own from '../constant/has-own-property'
import * as types from '../constant/types'
import combineHtmlExtensions from '../util/combine-html-extensions'
import chunkedPush from '../util/chunked-push'
