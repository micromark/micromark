...
// A code span (``` `alpha` ```).
// Includes `codeSpanSequence` and optionally `whitespace` and `codeSpanValue`.
exports.codeSpan = 'codeSpan'

// A code span fence (` `` `).
exports.codeSpanSequence = 'codeSpanSequence'

// Value of a code span (`alpha`).
exports.codeSpanValue = 'codeSpanValue'
...
exports.listMarker = 'listMarker'
exports.listPrefixWhitespace = 'listPrefixWhitespace'
